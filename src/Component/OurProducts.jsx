...
const Projects = () => {
  ...
  const projects = [
    {
      "name": "News Portal Nepali",
      "description": "My personal portfolio showcasing all my projects and skills.",
      "link": "https://theeverestnews.com",
      "seoImage": image1,
      "languages": ["nextjs", "mongodb", "tailwindcss","nodejs","api"]
    },
    {
      "name": "News Portal English",
      "description": "An e-commerce platform for buying and selling products.",
      "link": "https://english.theeverestnews.com",
      "seoImage": image2,
    ...
    },
    {
      "name": "Portfolio",
      "description": "A real-time weather app with a modern user interface.",
      "link": "https://portfolio-manish1996.vercel.app/",
      "seoImage": image3,
  ...
  return (
    <div>
        ...
        <div className="relative bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-center flex flex-col h-[80vh] w-full justify-center items-center font-sans text-white overflow-hidden">
                ...
                />
                <h1 className="font-extrabold text-5xl lg:text-6xl tracking-wide text-shadow-lg">Our Products</h1>
